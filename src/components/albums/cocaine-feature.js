...
const CocaineFeature = ({}) => {
  const data = useStaticQuery(graphql`
    query CocaineQuery {
      cocaineAlbum: file(relativePath: { eq: "cocaine-and-stuff.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 800) {
      ...
      <div className="container">
        ...
        <div className="columns">
          <div className="column is-half">
            <Img fluid={data.cocaineAlbum.childImageSharp.fluid} />
            <ExternalLink
          ...
          <div className="column is-half">
            <div className="content ">
              <p>
                WARRIOR SOUL released a new covers album, titled "Cocaine and Other Good Stuff", on XXX via{" "}
                <a
                  href="https://cargorecordsdirect.co.uk/products/warrior-soul-rock-n-roll-disease"
                  target="_blank"
